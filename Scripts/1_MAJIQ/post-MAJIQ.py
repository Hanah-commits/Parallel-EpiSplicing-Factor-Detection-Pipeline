...
def main(args):
    ...
    majiq_bed.to_csv(f'{proc}_0_Files/majiq.bed', index=False, sep='\t', header=False)  # input for bedtools intersect
    voila.to_csv(f'{proc}_0_Files/majiq_junctions.csv', index=False, sep='\t', header=True)
